...
d3.json("data/data1.json").then(data => {
    ...
    // run the visualization for the first time
    update2(filteredData);
});

// Example parseTime function (modify as needed)
function parseTime(year) {
    return d3.timeParse("%Y")(year);
}

// Example update2 function (modify as needed)
function update2(filteredData) {
    console.log(filteredData); // Add your visualization code here
}
